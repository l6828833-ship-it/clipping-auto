        ...
        <section className="sp-hero">
          ...
          <div className="sp-studio-wrap" id="workflow">
            <div className="sp-hero-characters" aria-hidden="true">
              ...
              <img className="crew-clip-finisher" src="/brand/clip-maker-clip-finisher-alpha.png" alt="" />
